    ...
    useEffect(() => {
        const getTrailers = async () => {
            try {
                ...
                setTrailers(res.data.content || []); // Change "trailers" to "content" if needed
            } catch (error) {
    ...
    useEffect(() => {
        const getsimilarcontent = async () => {
            try {
                ...
                setSimilarContent(res.data.similar || []); // Change "trailers" to "content" if needed
            } catch (error) {
                console.error("Error fetching trailers:", error);
                setSimilarContent([]);
            }
    ...
    useEffect(() => {
        const getcontentDetails = async () => {
            try {
                ...
                setContent(res.data.details || []); // Change "trailers" to "content" if needed
            } catch (error) {
                console.error("Error fetching trailers:", error);
                setContent([]);
            } finally {
            ...
            <div className='mx-auto container px-4 py-8 h-full'>
                ...
                {similarcontent.length > 0 && (
                    <div className='mt-12 max-w-5xl mx-auto relative'>
                        ...
                        {/* ✅ Add ref={sliderRef} here */}
                        <div ref={sliderRef} className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group scrollbar-hidden'>
