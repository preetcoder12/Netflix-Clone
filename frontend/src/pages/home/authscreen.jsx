	...
	return (
		<div className='hero-bg relative'>
			...
			<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
				...
				<Link to={"/login"} className='text-white bg-gradient-to-r from-[#e70717] to-[#e70717] py-1 px-2 rounded'>
					Sign In
				</Link>
			</header>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				<h1 className='text-4xl md:text-6xl font-extrabold mb-4'>Unlimited movies, TV<br></br> shows, and more</h1>
				<p className='text-lg mb-4 font-bold'>Starts at ₹149. Cancel at any time.</p>
				...
				<form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
					...
					/>
					<button className='bg-gradient-to-r from-[#e70717] to-[#e70717] text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
